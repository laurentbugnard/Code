...
sims = scan(L_list = [L], exponent_list = beta_list, xi_list = xi_list, method='alpha')
...
for sim in sims:
    group.create_dataset(f'L={L}alpha={sim.alpha:}xi={sim.xi}p={p}', data = sim.sigmaY)
